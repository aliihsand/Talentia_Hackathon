    ...
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Index(AppUserRegisterDto appUserRegisterDto)
        {
            ...
            if (result.Succeeded)
            {
                ...
                MailboxAddress mailboxAdressFrom = new MailboxAddress("Eticaret Uygulaması", "bursasporali88@gmail.com");
                ...
                client.Authenticate("bursasporali88@gmail.com", "pyxl kwie sdzy lzgg");
